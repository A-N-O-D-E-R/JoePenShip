...
/**
 * Shared boilerplate for {@link io.virtualization.sdk.vps.CreateVpsOperation}, composing a plain
 * {@link OperationHandle} for status/progress/error/await rather than reimplementing it. Mirrors
 * {@code io.virtualization.sdk.core.image.internal.ComposedOperation} — duplicated rather than
 * reused since that one is package-private to its own module.
 */
