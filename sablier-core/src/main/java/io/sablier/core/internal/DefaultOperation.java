package io.sablier.core.internal;
 ...
 * exceptionally), which is what makes {@link Operation#await()} never throw on a {@link
 * OperationStatus#FAILED} outcome.
 */
public final class DefaultOperation implements Operation, OperationHandle {
    ...
    private volatile SablierException error;
    ...
    @Override
    public void fail(SablierException cause) {
