...
import io.virtualization.sdk.core.internal.DefaultOperation;

/**
 * The producer side of an asynchronous {@link Operation}, used by provider modules to drive an
 * operation to completion from whatever async mechanism they use internally (task polling,
 * WebSocket events, QMP events).
 *
