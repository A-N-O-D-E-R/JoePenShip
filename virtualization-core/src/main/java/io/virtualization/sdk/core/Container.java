...
/** A provider-neutral view of a system container (e.g. an LXC or Incus container). */
public record Container(
    ...
    public Container(String id, String name, VirtualMachineState state, ComputeResources resources) {
